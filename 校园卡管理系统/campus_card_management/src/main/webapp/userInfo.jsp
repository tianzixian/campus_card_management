...
<div class="rg_layout">
    <div class="rg_form clearfix">
        <div class="rg_form_center">
            <!--注册表单-->
            <form id="registerForm" action="/user/update" method="post">
                <!--提交处理请求的标识符-->
<%--                <input type="hidden" name="name" value="${user.name}">--%>
                ...
                <table style="margin-top: 25px;">
                    ...
                    <tr>
                        ...
                        <td class="td_right">
                            <input type="text" id="username" name="username" value="${user.id}" disabled="disabled">
                        </td>
                    </tr>
                    <tr>
                        <td class="td_left">
                        ...
                        <td class="td_right">
                            <input type="text" style="width: 256px; float: right;" id="password" name="password" value="${user.password}">
                        </td>
                    </tr>
                    <tr>
                        <td class="td_left">
